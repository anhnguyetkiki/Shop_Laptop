                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($coupon as $key => $cp)
                       <tr>
                            ...
                            <td><?php $now = now()->format('d-m-Y'); ?>
                                @if($cp->coupon_date_end <= $now)
            ...
            <div class="modal-content">
                ...
                <form action="{{route('addnewcoupon')}}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">Ngày Bắt Đầu</label>
                            <input type="date" onblur="chinhNgay(this, 'coupon_date_end')" id="coupon_date_start" name="coupon_date_start" class="form-control" multiple />
                        </div>
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">Ngày Kết Thúc</label>
                            <input type="date" id="coupon_date_end" min="" name="coupon_date_end" class="form-control" multiple />
                        </div>
                        <div class="form-group">
                            <label style="font-weight: bold; color: #000">{{ trans('QL_sp.codecoupon') }}</label>
...
<script>
    function chinhNgay(coupon_date_start, coupon_date_end) {
        var inputNgayKetThuc = document.getElementById(coupon_date_end);
        inputNgayKetThuc.value = coupon_date_start.value;
        inputNgayKetThuc.min = coupon_date_start.value;
    };
</script>
@endsection
