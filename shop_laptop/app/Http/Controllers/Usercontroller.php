...
class Usercontroller extends Controller
{
    ...
    public function postVnpay_online(Request $req)
    {
        ...
        $vnp_TmnCode = config('barcode.VNP_TMN_CODE');
        $vnp_Url = config('barcode.VNP_URL');
        $vnp_HashSecret = config('barcode.VNP_HASH_SECRET');
        // dd($vnp_TmnCode, $vnp_ReturnUrl, $vnp_HashSecret);
